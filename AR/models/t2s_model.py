...
class Text2SemanticDecoder(nn.Module):
    def __init__(self, config, norm_first=False, top_k=3):
        ...
        self.ar_text_embedding = TokenEmbedding(
            self.embedding_dim-4, self.vocab_size, self.p_dropout
        )
    ...
    def forward(self, x, x_lens, y, y_lens, lang_emb):
        """
        x: phoneme_ids
        y: semantic_ids 也就是rep
        """
        ...
        #print(targets.max())#519
        #print(logits.shape)#B 125 58
