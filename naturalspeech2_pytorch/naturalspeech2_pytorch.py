...
def compute_pitch_pytorch(wav, sample_rate):
    #https://pytorch.org/audio/main/generated/torchaudio.functional.compute_kaldi_pitch#torchaudio.functional.compute_kaldi_pitch
...
class NaturalSpeech2(nn.Module):
    ...
    def ddpm_sample(self, shape, prompt = None, time_difference = None, cond_scale = 1., cond = None):
        ...
        for time, time_next in tqdm(time_pairs, desc = 'sampling loop time step', total = self.timesteps):
            ...
            mean = alpha_next * (yrraudio * (1 - c) / alpha + c * x_start)
    ...
    def forward(
        ...
        **kwargs
        ...
        assert d0 == self.dim, f'codec codebook dimension {d} must match model dimensions {self.dim}'
