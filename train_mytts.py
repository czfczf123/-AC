...
CONTINUE_PATH="YourTTS-EN-VCTK-May-13-2024_01+49PM-0000000"

# If you want to do transfer learning and speedup your training you can set here the path to the original YourTTS model
RESTORE_PATH =None#"YourTTS-EN-VCTK-February-13-2024_10+00AM-0000000/best_model.pth"
...
DATASETS_CONFIG_LIST = [aishell1_config,vctk_config,jvs_config]
...
trainer = Trainer(
    TrainerArgs(continue_path=CONTINUE_PATH,restore_path=RESTORE_PATH, skip_train_epoch=SKIP_TRAIN_EPOCH,use_ddp=True),
    config,
    output_path=OUT_PATH,
    model=model,
