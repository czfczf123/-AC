...
class LanguageManager(BaseIDManager):
    ...
    def parse_language_ids_from_config(c: Coqpit) -> Dict:
        ...
        languages.add("Northeastern")
        languages.add("Southwestern")
        languages.add("Jiao-Liao")
        languages.add("Beijing")
        languages.add("Zhongyuan")
        languages.add("Ji-Lu")
        languages.add("Lan-Yin")
        languages.add("Jiang-Huai")
        '''
        print("语言有哪些")
        print(languages)
