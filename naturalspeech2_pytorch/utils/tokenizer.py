...
_vowels = "iyɨʉɯuɪʏʊeøɘəɵɤoɛœɜɞʌɔæɐaɶɑɒᵻ"#元音
_non_pulmonic_consonants = "ʘɓǀɗǃʄǂɠǁʛ"#非肺部气流声
_pulmonic_consonants = "pbtdʈɖcɟkɡqɢʔɴŋɲɳnɱmʙrʀⱱɾɽɸβfvθðszʃʒʂʐçʝxɣχʁħʕhɦɬɮʋɹɻjɰlɭʎʟ"#肺部气流声
_suprasegmentals = "'̃ˈˌːˑ. ,-"#超音段特征
_other_symbols = "ʍwɥʜʢʡɕʑɺɧʲ"
_diacrilics = "ɚ˞ɫ"#附加符号
